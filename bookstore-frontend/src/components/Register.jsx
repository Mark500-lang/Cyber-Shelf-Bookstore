        ...
        <section className="bg-gray-100 min-h-screen flex box-border justify-center items-center">
            <div className="bg-[#ffffff] rounded-2xl flex max-w-3xl p-5 items-center">
                <div className="md:w-1/2 px-8">
                    ...
                    <div className="mt-6  items-center text-black">
                    ...
                    <div className="mt-4 text-sm flex justify-between items-center container-mr">
                        ...
                        <Link to='/login' className="hover:border register rounded-xl py-2 px-5 hover:scale-110 font-semibold duration-300 bg-[#002D74] text-white  hover:bg-[#2053b1]">Login</Link>
                    </div>
                </div>
                <div className="md:block hidden w-1/2">
                    <img className="rounded-2xl max-h-[1600px]" src="./assets/person-reading.jpg" alt="Register form"/>
                </div>
            </div>
        </section>
    )
